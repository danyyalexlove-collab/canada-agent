          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
            ...
            <div style={{ textAlign: "right" }}>
              {subscriber ? (
                ...
                <button onClick={() => window.open("https://buy.stripe.com/fZu6oHdyRgihdsh0N88g00b", "_blank")} style={{ background: "#D4192C", color: "#fff", border: "none", borderRadius: 12, padding: "12px 18px", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 13, cursor: "pointer", transition: "transform 0.15s", lineHeight: 1.3 }}
        ...
        {activeTab === "news" && (
          <div style={{ animation: "fadein 0.3s ease" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
              ...
              {!subscriber && (
                <button onClick={() => window.open("https://buy.stripe.com/fZu6oHdyRgihdsh0N88g00b", "_blank")} style={{ background: "#1a1a1a", color: "#fff", border: "none", borderRadius: 10, padding: "10px 14px", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 12, cursor: "pointer", lineHeight: 1.4, textAlign: "center" }}>
